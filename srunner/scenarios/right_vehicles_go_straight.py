...
class RightVehiclesGoStraight(BasicScenario):
    """
    RightVehiclesGoStraight scenario:
    ego vehicle at a signalized intersection,
    while other vehicle is going straight from the right intersection
    """
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False, debug_mode=False, criteria_enable=True,
        ...
        super(RightVehiclesGoStraight, self).__init__("RightVehiclesGoStraight",
                                                      ego_vehicles,
                                                      config,
                                                      world,
                                                      debug_mode,
    ...
    def _create_behavior(self):
        ...
        while other actor driving straight from right intersection
        Order of sequence:
