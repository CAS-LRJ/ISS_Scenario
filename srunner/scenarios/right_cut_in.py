...
class FrontRightCutIn(BasicScenario):
    """
    FrontRightCutIn scenario:
    The ego runs straight on the road. When it is close to a front vehicle in the right lane,
    the vehicle cuts in
    """
    timeout = 1200
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False, debug_mode=False, criteria_enable=True,
        ...
        super(FrontRightCutIn, self).__init__("FrontRightCutIn",
                                              ego_vehicles,
                                              config,
                                              world,
                                              debug_mode,
    ...
    def _initialize_actors(self, config):
        ...
        waypoint = waypoint1.get_right_lane()
...
class BehindRightCutIn(BasicScenario):
    """
    BehindRightCutIn scenario:
    The ego is going  straight on the road,
    while another vehicle behind the ego is accelerating and changing lane from right
    """
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False, debug_mode=False, criteria_enable=True,
        ...
        super(BehindRightCutIn, self).__init__("BehindRightCutIn",
                                               ego_vehicles,
                                               config,
                                               world,
                                               debug_mode,
    ...
    def _initialize_actors(self, config):
        ...
        # get the right waypoint
        waypoint = waypoint1.get_right_lane()
        lane_width = waypoint1.lane_width
        location = waypoint.transform.location
    ...
    def _create_behavior(self):
        ...
        # lane_change
        lane_change = LaneChange(
            self.other_actors[0], speed=None, direction='left', distance_same_lane=5,
