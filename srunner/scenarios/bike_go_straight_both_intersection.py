...
class PedestrianGoStraightBothIntersection(BasicScenario):
    """
    PedestrianGoStraightBothIntersection scenario:
    The ego vehicle is turing left at an T intersection,
    while cyclists are walking straight from left and right intersection
    """
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False, debug_mode=False, criteria_enable=True,
        ...
        super(PedestrianGoStraightBothIntersection, self).__init__("PedestrianGoStraightBothIntersection",
                                                                   ego_vehicles,
                                                                   config,
                                                                   world,
                                                                   debug_mode,
    ...
    def _create_behavior(self):
        ...
        ##########################################################################################################
        left_vehicle_turn_left = py_trees.composites.Sequence()
        ...
        left_vehicle_turn_left.add_child(StopVehicle(self.other_actors[1], 1.0))
