...
class CutInWithObstacle(BasicScenario):
    """
    CutInWithObstacle scenario:
    Ego vehicle is driving straight on the road
    Another car is cutting in the road front a vehicle
    """
    timeout = 1200
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False, debug_mode=False, criteria_enable=True,
        ...
        super(CutInWithObstacle, self).__init__("CutInWithObstacle",
                                                ego_vehicles,
                                                config,
                                                world,
                                                debug_mode,
    ...
    def _initialize_actors(self, config):
        ...
        # obstacle
        self.transform_obstacle, _ = self._calculate_base_transform(self._start_distance - 6, waypoint)
