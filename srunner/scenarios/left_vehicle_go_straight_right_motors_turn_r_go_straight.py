...
class LeftVehicleGoStraightRightMotorsTurnRGoStraight(BasicScenario):
    """
    LeftVehicleGoStraightRightMotorsTurnRGoStraight scenario:
    ...
    a vehicle is driving straight from left intersection
    """
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False, debug_mode=False, criteria_enable=True,
        ...
        super(LeftVehicleGoStraightRightMotorsTurnRGoStraight, self).__init__(
    ...
    def _create_behavior(self):
        ...
        continue_driving_waypoints3 = WaypointFollower(
            self.other_actors[2], self.velocity2, plan=plan3, avoid_collision=True)
        left_vehicle_go_straight.add_child(continue_driving_waypoints3)
        left_vehicle_go_straight.add_child(StopVehicle(self.other_actors[2], 1.0))
