...
class RightVehiclesTurnRight(BasicScenario):
    """
    RightVehiclesTurnRight scenario:
    ego vehicle at a signalized intersection,
    while other vehicle is turing right from the right intersection
    """
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False, debug_mode=False, criteria_enable=True,
        ...
        self._blackboard_queue_name = 'RightVehiclesTurnRight/actor_flow_queue'
        ...
        super(RightVehiclesTurnRight, self).__init__("RightVehiclesTurnRight",
                                                     ego_vehicles,
                                                     config,
                                                     world,
                                                     debug_mode,
    ...
    def _create_behavior(self):
        ...
        while other actor turing right from right intersection
        Order of sequence:
