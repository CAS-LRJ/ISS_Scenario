...
class VehicleReverse(BasicScenario):
    """
    VehicleReverse scenario:
    ego is driving straight on the road
    while another vehicle is reversing
    """
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False, debug_mode=False, criteria_enable=True,
        ...
        super(VehicleReverse, self).__init__("VehicleReverse",
                                             ego_vehicles,
                                             config,
                                             world,
                                             debug_mode,
    ...
    def _create_behavior(self):
        ...
        - keep_velocity: reverse along the road
