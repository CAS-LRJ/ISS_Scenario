...
class LeftVehiclesTurnLeft(BasicScenario):
    """
    LeftVehiclesTurnLeft scenario:
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False, debug_mode=False, criteria_enable=True,
        ...
        self._blackboard_queue_name = 'LeftVehiclesTurnLeft/actor_flow_queue'
        ...
        super(LeftVehiclesTurnLeft, self).__init__("LeftVehiclesTurnLeft",
                                                   ego_vehicles,
                                                   config,
                                                   world,
                                                   debug_mode,
