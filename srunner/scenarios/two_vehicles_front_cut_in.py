...
class TwoVehiclesFrontCutIn(BasicScenario):
    """
    TwoVehiclesFrontCutIn scenario:
    Ego vehicle is driving straight on the road
    there are tow vehicles beside the ego, and front vehicle cut in
    """
    timeout = 1200
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False, debug_mode=False, criteria_enable=True,
        ...
        super(TwoVehiclesFrontCutIn, self).__init__("TwoVehiclesFrontCutIn",
                                                    ego_vehicles,
                                                    config,
                                                    world,
                                                    debug_mode,
    ...
    def _create_behavior(self):
        ...
        just_drive.add_child(
            InTriggerDistanceToVehicle(self.other_actors[1], self.ego_vehicles[0], self._trigger_distance))
        just_drive.add_child(WaypointFollower(self.other_actors[0], self._velocity, avoid_collision=True))
        ...
        behaviour.add_child(WaypointFollower(self.other_actors[1], self._velocity2, avoid_collision=True))
