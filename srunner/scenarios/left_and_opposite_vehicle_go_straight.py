...
class LeftOppositeVehicleGoStraight(BasicScenario):
    """
    LeftOppositeVehicleGoStraight scenario:
    The ego vehicle is going straight at an intersection,
    while vehicles are crossing the intersection from the opposite and left intersection
    """
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False, debug_mode=False, criteria_enable=True,
        ...
        super(LeftOppositeVehicleGoStraight, self).__init__("LeftOppositeVehicleGoStraight",
                                                            ego_vehicles,
                                                            config,
                                                            world,
                                                            debug_mode,
    ...
    def _calculate_opposite_transform(self, _start_distance, waypoint):
        ...
        waypoint = self._wmap.get_waypoint(location)
        flag = waypoint.lane_id
        # Move to the right lane of the opposite intersection
        ...
        # print(waypoint.get_left_lane().get_left_lane().get_left_lane().lane_id)
    ...
    def _initialize_actors(self, config):
        ...
        self._other_actor_transform, orientation_yaw = self._calculate_left_transform(self._start_distance, waypoint)
    ...
    def _create_behavior(self):
        ...
        # Selecting straight path at intersection   # opposite vehicle's plan
        ...
        #########################################################################################################
        # left vehicle follow waypoints until next intersection
        ...
        left_vehicle_go_straight.add_child(continue_driving_waypoints)
        left_vehicle_go_straight.add_child(StopVehicle(self.other_actors[0], 1.0))

        ##########################################################################################################
        # opposite vehicle follow waypoints until next intersection
        opposite_vehicle_go_straight = py_trees.composites.Sequence()
        ...
        opposite_vehicle_go_straight.add_child(StopVehicle(self.other_actors[1], 1.0))
