...
class BikeCrossIntersectionObliquely(BasicScenario):
    """
    BikeCrossIntersectionObliquely scenario:
    The ego vehicle at an intersection,
    while bike_cross_intersection_obliquely
    """
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False, debug_mode=False, criteria_enable=True,
        ...
        super(BikeCrossIntersectionObliquely, self).__init__("BikeCrossIntersectionObliquely",
                                                             ego_vehicles,
                                                             config,
                                                             world,
                                                             debug_mode,
