...
class OccupyTheMiddleLine(BasicScenario):
    """
    OccupyTheMiddleLine scenario:
    ego is driving straight on the road
    while another vehicle is driving with occupy the middle line
    """
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False, debug_mode=False, criteria_enable=True,
        ...
        super(OccupyTheMiddleLine, self).__init__("OccupyTheMiddleLine",
                                                  ego_vehicles,
                                                  config,
                                                  world,
                                                  debug_mode,
    ...
    def _initialize_actors(self, config):
        ...
        # occupy the middle line
        offset = {"orientation": 0, "position": -90, "z": 0.6, "k": 0.4}
    ...
    def _create_behavior(self):
        """
        Ego is going straight on the road
        while another vehicle is driving with occupy the middle line
        Order of sequence:
