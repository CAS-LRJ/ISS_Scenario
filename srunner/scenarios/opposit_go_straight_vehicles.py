...
class OppositeGoStraightVehicles(BasicScenario):
    """
    OppositeGoStraightVehicles scenario:
    ego vehicle at an intersection,
    while other vehicle is driving straight from the opposite intersection
    """
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False, debug_mode=False, criteria_enable=True,
        ...
        self._blackboard_queue_name = 'OppositeGoStraightVehicles/actor_flow_queue'
        ...
        super(OppositeGoStraightVehicles, self).__init__("OppositeGoStraightVehicles",
                                                         ego_vehicles,
                                                         config,
                                                         world,
                                                         debug_mode,
    ...
    def _calculate_base_transform(self, _start_distance, waypoint):
        ...
        while True:
            ...
            if wp_next is None or wp_next.lane_type == carla.LaneType.Sidewalk:
                ...
                waypoint = wp_next.get_left_lane()
            else:
                waypoint = wp_next
    ...
    def _create_behavior(self):
        ...
        actor_source = ActorSource(
            ...
            self._other_actor_transform, 5, self._blackboard_queue_name, 4)
        ...
        # 将ego和actor前边路口的红绿灯设置为绿色和红色，路口无交通灯也可以执行
