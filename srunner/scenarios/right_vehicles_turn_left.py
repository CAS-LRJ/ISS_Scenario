...
class RightVehiclesTurnLeft(BasicScenario):
    """
    RightVehiclesTurnLeft scenario:
    ego vehicle at a signalized intersection,
    while other vehicle is turing left from the right intersection
    """
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False, debug_mode=False, criteria_enable=True,
        ...
        self._ego_distance = 500
        self._traffic_light = None
        self._other_actor_transform = None
        self._blackboard_queue_name = 'RightVehiclesTurnLeft/actor_flow_queue'
        ...
        super(RightVehiclesTurnLeft, self).__init__("RightVehiclesTurnLeft",
                                                    ego_vehicles,
                                                    config,
                                                    world,
                                                    debug_mode,
    ...
    def _create_behavior(self):
        ...
        while other actor turing left from right intersection
        Order of sequence:
        ...
        #     self.debug.draw_point(plan[i][0].transform.location + carla.Location(z=0.5), size=0.5, life_time=0)

        # adding flow of actors
        actor_source = ActorSource(
            ['vehicle.tesla.model3', 'vehicle.audi.tt'],
            self._other_actor_transform, 10, self._blackboard_queue_name, 2)
        ...
        # Set the traffic light at the intersection in front of ego and actor
