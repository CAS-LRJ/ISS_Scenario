...
class RightOppositeVehicleGoStraight(BasicScenario):
    """
    RightOppositeVehicleGoStraight scenario:
    The ego vehicle is going straight at an intersection,
    while vehicles are crossing the intersection from the opposite and right intersection
    """
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False, debug_mode=False, criteria_enable=True,
        ...
        super(RightOppositeVehicleGoStraight, self).__init__("RightOppositeVehicleGoStraight",
                                                             ego_vehicles,
                                                             config,
                                                             world,
                                                             debug_mode,
