...
class LeftVehicleTurnLRightVehicleTurnR(BasicScenario):
    """
    LeftVehicleTurnLRightVehicleTurnR scenario:
    The ego vehicle is going straight at an intersection,
    while a vehicle is turing left from  left and another vehicle is turing right from the right intersection
    """
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False, debug_mode=False, criteria_enable=True,
        ...
        super(LeftVehicleTurnLRightVehicleTurnR, self).__init__("LeftVehicleTurnLRightVehicleTurnR",
                                                                ego_vehicles,
                                                                config,
                                                                world,
                                                                debug_mode,
