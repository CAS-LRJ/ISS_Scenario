...
class ScenarioConfiguration(object):
    ...
    # (in the scene where there is a vehicle on the opposite side of the intersection when ego is turning left,
    ...
    _model = None
    # control_loss noise for steer [-0.5,0.5]
    _new_steer_noise = None
    _new_steer_noise2 = None
    # control_loss noise for throttle [0-1]
