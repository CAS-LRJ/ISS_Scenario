...
from srunner.tools.scenario_helper import generate_target_waypoint, get_location_in_distance_from_wp, \
    generate_target_waypoint_list, return_target_waypoint_list


class OppositeRightTurningVehicles(BasicScenario):
    """
    OppositeRightTurningVehicles scenario:
    ego vehicle at an intersection,
    while other vehicle is turing right from the opposite intersection
    """
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False, debug_mode=False, criteria_enable=True,
        ...
        self._ego_distance = 200
        self._traffic_light = None
        self._other_actor_transform = None
        self._blackboard_queue_name = 'OppositeRightTurningVehicles/actor_flow_queue'
        ...
        super(OppositeRightTurningVehicles, self).__init__("OppositeRightTurningVehicles",
                                                           ego_vehicles,
                                                           config,
                                                           world,
                                                           debug_mode,
    ...
    def _calculate_base_transform(self, _start_distance, waypoint):
        ...
        # Move to the most right lane of the opposite intersection
        while True:
    ...
    def _create_behavior(self):
        ...
        actor_source = ActorSource(
            ...
            self._other_actor_transform, 10, self._blackboard_queue_name, 4)

        # destroying flow of actors
        actor_sink = ActorSink(plan[-1][0].transform.location, 1)
