...
class Retrograde(BasicScenario):
    """
    Retrograde scenario:
    ego is going straight, while another vehicle is running conversely
    """
    timeout = 1200
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False, debug_mode=False, criteria_enable=True,
        ...
        super(Retrograde, self).__init__("Retrograde",
                                         ego_vehicles,
                                         config,
                                         world,
                                         debug_mode,
    ...
    def _initialize_actors(self, config):
        ...
        # driving conversely
        offset = {"orientation": 180, "position": 0, "z": 0.6, "k": 1.0}
    ...
    def _create_behavior(self):
        ...
        - trigger_distance: ego drive until in trigger distance to ego_vehicle
        - just_drive: driving conversely
        ...
        just_drive.add_child(actor_velocity)
        just_drive.add_child(actor_drive)
