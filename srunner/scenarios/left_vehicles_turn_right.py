...
class LeftVehiclesTurnRight(BasicScenario):
    """
    LeftVehiclesTurnRight scenario:
    ego vehicle at a signalized intersection,
    while other vehicle is turing right from the left intersection
    """
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False, debug_mode=False, criteria_enable=True,
        ...
        self._blackboard_queue_name = 'LeftVehiclesTurnRight/actor_flow_queue'
        ...
        super(LeftVehiclesTurnRight, self).__init__("LeftVehiclesTurnRight",
                                                    ego_vehicles,
                                                    config,
                                                    world,
                                                    debug_mode,
