...
class OppositeLeftTurningVehicles(BasicScenario):
    """
    OppositeRightTurningVehicles scenario:
    ego vehicle at an intersection,
    while other vehicle is turing left from the opposite intersection
    """
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False, debug_mode=False, criteria_enable=True,
        ...
        self._blackboard_queue_name = 'OppositeLeftTurningVehicles/actor_flow_queue'
        ...
        super(OppositeLeftTurningVehicles, self).__init__("OppositeLeftTurningVehicles",
                                                          ego_vehicles,
                                                          config,
                                                          world,
                                                          debug_mode,
    ...
    def _create_behavior(self):
        ...
        actor_sink = ActorSink(plan[-1][0].transform.location, 5)
